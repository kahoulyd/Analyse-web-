...
class AnalysisController extends Controller
{
    ...
    {
        //echo(substr(getcwd(), 0,strpos(getcwd(), 'AnalyseWeb'))."AnalyseWeb/app/Http/Controllers/AnalyseWebCompilation");
        chdir(substr(getcwd(), 0,strpos(getcwd(), 'analyse-web-2'))."analyse-web-2/app/Http/Controllers/AnalyseWebCompilation");
